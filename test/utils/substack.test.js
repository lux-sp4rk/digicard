import { getFeaturedPost } from '../../src/utils/substack';
...
describe('getFeaturedPost', () => {
  ...
  it('fetches post from Netlify function successfully', async () => {
    const mockPost = {
      ...
      thumbnail_url: 'https://substackcdn.com/image/test.jpg',
    ...
    expect(mockFetch).toHaveBeenCalledWith(
      '/.netlify/functions/substack-proxy'
    );
  ...
  it('logs error to console when fetch fails', async () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(
      'Error fetching featured post from Substack:',
      expect.any(Error)
    );
  ...
  describe('caching', () => {
    ...
    it('bypasses cache when expired', async () => {
      ...
      const newPost = { ...mockPost, title: 'New Post' };
      mockFetch.mockResolvedValueOnce({
        ok: true,
    ...
    it('bypasses cache when missing', async () => {
      ...
      localStorageMock.removeItem('substack_featured_post');
      localStorageMock.getItem.mockClear();
    ...
    it('handles corrupted cache gracefully', async () => {
      ...
      localStorageMock.setItem('substack_featured_post', 'invalid json');
      localStorageMock.getItem.mockClear();
      localStorageMock.removeItem.mockClear();
